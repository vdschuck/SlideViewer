...
/**
 * Implementa��o de uma lista linear com armazenamento din�mico, baseado em n�s
 * singularmente encadeados (encadeamento somente em um sentido).
 */
public class SinglyLinkedList<E> implements List<E> {
    ...
    public E removeFirst() {
        ...
        if (head == tail) {
            head = tail = null;
        } else // ...sen�o, o segundo elemento passa a ser o "head"
        {
            head = head.getNext();
        }
